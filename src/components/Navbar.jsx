    ...
    <header className={`fixed w-full z-50 transition-colors duration-300 ${
      ...
      <div className="container mx-auto px-4 py-3 flex items-center relative">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className={`font-bold ${theme === "dark" ? "text-primary" : "text-black"}`}>
            CoffeeSite
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-4 ml-auto">
          ...
          <button onClick={() => navigate('/profile')}>
            <img src="data:image/jpeg;base64,..." alt="Profile" className="h-8 w-8 rounded-full object-cover border-2 border-primary" />
          </button>
        </div>
